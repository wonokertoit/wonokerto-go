        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h1 className="text-xl font-bold text-gray-900">Review Pengajuan</h1>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-xl p-4">
                ...
                <p className="text-sm font-medium text-gray-900">{app.type === 'SKU' ? 'Surat Keterangan Usaha' : 'Surat Pengantar SKCK'}</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-4">
              ...
              {app.nomorSurat && (
                <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-100">
                  ...
                  <p className="text-sm font-medium text-emerald-900">{app.nomorSurat}</p>
                </div>
              )}
              {app.detailUsaha && (
                <div className="bg-gray-50 rounded-xl p-4">
              ...
              {app.keteranganLain && (
                <div className="bg-gray-50 rounded-xl p-4">
                  <p className="text-xs text-gray-500 mb-1">Keterangan Lain</p>
                  <p className="text-sm font-medium text-gray-900">{app.keteranganLain}</p>
                </div>
              )}
            </div>
          </div>
